...
**Structure**
- 根目录保留：`.github/`、`README.md`、`.gitignore`、`public/`（可备份删除）等。
...
**Removing / Backing up old public**
- 备份示例：
  - `Rename-Item -Path public -NewName public.bak`
  - 或:
    - `New-Item -ItemType Directory -Path backup -Force`
    - `Move-Item -Path public -Destination backup\public_backup`
